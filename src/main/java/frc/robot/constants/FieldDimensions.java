...
/**
 * Constants regarding the positions of waypoints on the field. All dimensions are relative to the <a href="https://docs.wpilib.org/en/stable/docs/software/basic-programming/coordinate-system.html#always-blue-origin">always blue origin</a> convention
 */
