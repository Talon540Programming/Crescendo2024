...
public interface ModuleIO {
  ...
  public static class ModuleIOInputs {
    // Drive
    public boolean driveConnected = false; // Not in 16.0 Comp Code
    public double drivePositionRad = 0.0;
    public double driveVelocityRadPerSec = 0.0;
    public double driveAppliedVolts = 0.0;
    public double driveCurrentAmps = 0.0;
    public double driveTempCelsius = 0.0; // Not in 16.0 Comp Code
    // Turn
    ...
    public double turnTempCelsius = 0.0; // Not in 16.0 Comp Code
    // Wheel positions?
    public double[] odometryDrivePositionsRad = new double[] {};
    public Rotation2d[] odometryTurnPositions = new Rotation2d[] {};
  }

  // 16.0 Comp has a clone of this. Why?  Needed? No!
