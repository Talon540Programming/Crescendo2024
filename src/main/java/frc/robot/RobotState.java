...
// import frc.robot.subsystems.drive.DriveConstants; // not in 6328
// //// import frc.robot.subsystems.vision.VisionBase; //not in 6328
// //// import frc.robot.subsystems.vision.VisionConstants; //not in 6328
// //// import frc.robot.util.AllianceFlipUtil; //not in 6328
// import frc.robot.util.GeometryUtil; // not in 6328
// import frc.robot.util.LoggedTunableNumber; // not in 6328
// import java.util.*;
...
//   private static final Matrix<N3, N1> odometryStateStdDevs = VecBuilder.fill(0.003, 0.003,
// 0.002);
...
//   //       new Pose3d(
//   //               Translation3d.kZero,
//   //               new Rotation3d(0, observation.pitch().getRadians(),
